...
public class SuperAdmin extends JFrame {
    ...
    public SuperAdmin(Connection c) {
        ...
        sterge.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                date = ExecProc.getData(Model.c, "select u.*,a.id_unitate from utilizator u,angajat a where a.id=u.id;");
        ...
        adaugaprogram= new JButton("Adauga program unitate");
        ...
        adaugau= new JButton("Adauga unitate");
