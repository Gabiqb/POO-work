...
public class DBPrinter {
    ...
    public static String[] printTable(Connection conn, String tableName){
        String[] printformatstring= printTable(conn, tableName, DEFAULT_MAX_ROWS, DEFAULT_MAX_TEXT_COL_WIDTH);
    ...
    public static String[] printTable(Connection conn, String tableName, int maxRows, int maxStringColWidth) {
        ...
        try {
            ...
            printformatstring=printResultSet(rs, maxStringColWidth);
    ...
    public static String[] printResultSet(ResultSet rs, int maxStringColWidth) {
        ...
        try {
             ...
             */
            String[] printformatstring=new String[20];
          ...
          //  printformatstring=printformatstring + strToPrint.toString();
            ...
            for (int i = 0; i < rowCount; i++) {
                for (Column c : columns) {
                   ...
                   // printformatstring=printformatstring + " " + format;
                //    printformatstring=printformatstring + String.format(format, c.getValue(i));
                    System.out.print(String.format(format, c.getValue(i)));

                }
             //   printformatstring=printformatstring + "|\n";
              //  printformatstring=printformatstring + rowSeparator;
                System.out.println("|");
